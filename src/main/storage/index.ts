...
export { ClineSessionStorage } from './cline-session-storage';
...
import { ClineSessionStorage } from './cline-session-storage';
...
export function initializeSessionStorages(options?: InitializeSessionStoragesOptions): void {
	...
	registerSessionStorage(new ClineSessionStorage());
}
